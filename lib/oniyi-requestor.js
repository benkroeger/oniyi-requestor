...
Requestor.prototype.throttle = function(opts) {
  var self = this;
  if (self.limiter[opts.parsedUrl.host]) {
    return self.limiter[opts.parsedUrl.host].getBucket(function(err, bucket) {
      if (err) {
...
Requestor.prototype.handleRequest = function(options) {
  ...
  if ((!self.redisClient.connected) || self.disableCache) {
